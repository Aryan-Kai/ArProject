...
public class Assesment2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(Question2Answer.question[currentQuestionIndex]);
        ansA.setText(Question2Answer.choices[currentQuestionIndex][0]);
        ansB.setText(Question2Answer.choices[currentQuestionIndex][1]);
        ansC.setText(Question2Answer.choices[currentQuestionIndex][2]);
        ansD.setText(Question2Answer.choices[currentQuestionIndex][3]);
